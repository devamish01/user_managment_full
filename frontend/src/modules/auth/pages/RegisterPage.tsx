/**
 * RegisterPage — composition root for the registration surface.
 *
    ...
    <div className="w-full max-w-6xl">
        ...
        <section className="hidden lg:block min-h-[580px] flex flex-col justify-center">
          <div className="relative z-10 max-w-2xl w-full text-center">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-lg mx-auto mb-10 animate-fade-in-up">
              Join our community to discover events, enter giveaways, support causes, and manage payments securely.
            </p>
      ...
      <div className="mt-10 lg:mt-16 text-center">
        ...
        <p className="text-sm text-muted-foreground mt-2">
          ...
          <Link to="/login" className="font-semibold text-primary underline decoration-primary/30 hover:text-primary/80">
            Sign in
          </Link>
        </p>
      </div>
