...
import type { GenericQueryParams, Pagination } from "@/api";
...
export const StoreProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const { pagination: usersPagination, ...usersRest } = usersStore;
  ...
  const value = React.useMemo(
    () => ({
      ...
      ...rolesStore,
      ...permissionsStore,
      // Legacy pagination record
      pagination: { users: usersPagination } as Record<string, Pagination>,
      // Global state
      departments,
      logs,
